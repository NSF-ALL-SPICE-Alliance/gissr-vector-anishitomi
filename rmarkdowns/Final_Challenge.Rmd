...
locations_oahu <- data.frame(
  name = c("The Queen's Medical Center", "The Queen's West Medical Center", "Kaiser Permanente Moanalua Medical Center", "Pali Momi Medical Center",
  ...
  type = c(rep("Hospital", 10), rep("Courthouse", 7), rep("Prison", 4)),
  lat = c(21.3099, 21.3441, 21.3754, 21.3854, 21.3045, 21.2956, 21.3889, 21.3210, 21.5016, 21.3606,
          21.3073, 21.3066, 21.3355, 21.3386, 21.5022, 21.4443, 21.4036,
          21.3242, 21.3853, 21.3985, 21.4448),
  lng = c(-157.8545, -158.0250, -157.8870, -157.9458, -157.8511, -157.8419, -157.7896, -157.8567, -158.0190, -157.8902,
...
In comparison to the 2nd and 3rd maps, we can notice that there are a few locations missing from map 2 to map 3. In map 2, I used the OSM data. In map 3, I utilized all coordinates of the possible locations that I can find. The missing data can be referred back to how much of the data is current. Or, what is considered a hospital, courthouse, and prison. 

Based on the Leaflet map, we can see that the Federal Detention Center has the best access to a Courthouse and Hospital. Correctional facilities do have better access to Hospitals, but they would require longer distances of travel to the federal courthouse. 
