...
I think that looking at the population density is something that can be incorporated into this project. The island of Oahu is essentially building on top of what is already built and will soon run out of space on the island to add facilities to widstand the population growth over time. With that being said, crime is also bound to increase as well. So will the state continue to send inmates to the other states? Or, will they find a way to build a new facillity?
